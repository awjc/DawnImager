...
public class DawnImagerVesta {
	...
	private static String STATUS_FILE = "status-vesta.txt";
...
//						System.out.println("Skipped image!");
			...
			try{
				...
				status.write("Vesta: last updated " + timeStamp + System.getProperty("line.separator"));
				status.close();
			} catch(Exception e){
//				e.printStackTrace();
			}
