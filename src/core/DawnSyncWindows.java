...
public class DawnSyncWindows {
	private static String srcDir = "Z:\\Dawn\\Images\\";
	private static String destDir = "C:\\Users\\Adam\\Dropbox\\Java_Projects\\DawnImager\\Images\\";
	//private static String srcDir = "../../../../../../../z/Dawn/Images/";
	...
	public static void main(String[] args){
		String[] names = { "sun", "earth", "ceres", "traj", "vesta" };
		if(args.length > 0){
			names = args;
		}
...
//					destImg.close();
//				}
				System.out.println("CHECKING FILE: " + srcName);
