...
public class DawnImagerCeres {
	private static final String DAWN_VESTA_URL = "http://neo.jpl.nasa.gov/orbits/fullview2.jpg";
	...
	private static String STATUS_FILE = "status-ceres.txt";
...
//						System.out.println("Skipped image!");
			...
			try{
				...
				status.write("Ceres: last updated " + timeStamp + System.getProperty("line.separator"));
				status.close();
			} catch(Exception e){
//				e.printStackTrace();
			}
